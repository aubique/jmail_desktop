...
import com.jmail.view.ColorTheme;
import com.jmail.view.FontSize;
...
public class OptionsWindowController extends BaseController implements Initializable {
    ...
    private void setUpSizePicker() {
        ...
        fontSizePicker.setValue(viewFactory.getColorTheme().ordinal());
        ...
        fontSizePicker.setLabelFormatter(new StringConverter<Double>() {
            @Override
            public String toString(Double themeIndex) {
                int i = themeIndex.intValue();
